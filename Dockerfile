...
RUN DD_API_KEY=a8d87779d248091bddc2f18a15467d88 DD_SITE="us5.datadoghq.com" DD_APM_INSTRUMENTATION_ENABLED=host DD_HOSTNAME=default bash -c "$(curl -L https://s3.amazonaws.com/dd-agent/scripts/install_script_agent7.sh)"
